...
- **Base swap per cell** — Inline rice/roti/paratha/pav/noodles buttons
- **At least 1 AI meal per week** — AI suggestions auto-merged into grid on first load
...
- **Review Plan** → AI-optimized grocery list + weekly chart + finalize

### Output 1 — Weekly Meal Chart
Day-wise formatted text. One-click copy per day or full week.

### Output 2 — Grocery List
Auto-generated and AI-optimized. Per-item edit (qty/unit) and remove. Grouped by category. AI fixes nonsensical quantities before display.
